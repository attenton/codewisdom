...
function Neo4jD3 (_selector, _options) {
  ...
  function appendTilte (node) {
    return node.append('node-title')
  ...
  function init (_selector, _options) {
    ...
    } else if (options.D3Data) {
      loadD3Data(_options.D3Data)
    } else {
  ...
  */
  ...
  function toString (d) {
    ...
    Object.keys(d.majority_properties).forEach(function (property) {
      s += ', ' + property + ': ' + JSON.stringify(d.majority_properties[property])
    })
